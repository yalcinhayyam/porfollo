      ...
      <div className="prose prose-neutral dark:prose-invert">
        ...
        <section className="mb-8">
          ...
          <div className="space-y-6">
            <div>
              <h3 className="font-semibold">Veripark (June 2023 – May 2025)</h3>
              ...
              <p>
                ...
                <br />
                🔗{" "}
                <a href="https://banking.innovationcu.ca" target="_blank" rel="noopener noreferrer">
                  banking.innovationcu.ca
                </a>
              </p>
            </div>
            ...
            <div>
              <h3 className="font-semibold">Wadaaa Marketplaces, Texas USA (2021 – Feb 2022)</h3>
              <p className="text-neutral-600 dark:text-neutral-400 mb-2">
                <em>Frontend Developer</em>
              </p>
              <p>
                ...
                <br />
                🔗{" "}
                <a href="https://www.wadaaa.com" target="_blank" rel="noopener noreferrer">
                  wadaaa.com
                </a>
              </p>
            </div>
            ...
            <div>
              <h3 className="font-semibold">Morphosium Software (Feb 2022 – Aug 2022)</h3>
              <p className="text-neutral-600 dark:text-neutral-400 mb-2">
                <em>Frontend Developer</em>
              </p>
              <p>
            ...
            <div>
              <h3 className="font-semibold">Zensoft Software (Jan 2020 – May 2022)</h3>
              <p className="text-neutral-600 dark:text-neutral-400 mb-2">
                <em>Full-Stack & Frontend Developer</em>
              </p>
              <p>
                ...
                <br />
                🔗{" "}
                <a href="https://zensoft.com.tr" target="_blank" rel="noopener noreferrer">
                  zensoft.com.tr
                </a>
              </p>
            </div>
            ...
            <table className="min-w-full">
              <thead>
                <tr>
                  ...
                  <th className="px-4 py-2 text-left">Writing</th>
                  <th className="px-4 py-2 text-left">Speaking</th>
                  <th className="px-4 py-2 text-left">Listening</th>
                </tr>
              </thead>
              <tbody>
                <tr>
        ...
        <section className="mb-8">
          ...
          <ul className="space-y-2">
            <li>
              <strong>Phone:</strong>{" "}
              <a href="tel:+905060668012" className="hover:underline">
                +90 506 066 80 12
              </a>
            </li>
            <li>
              <strong>Email:</strong>{" "}
              <a href="mailto:hayyamyalcin@hotmail.com" className="hover:underline">
                hayyamyalcin@hotmail.com
              </a>{" "}
              /{" "}
              <a href="mailto:hayyamyalcin@gmail.com" className="hover:underline">
                hayyamyalcin@gmail.com
              </a>
            </li>
            <li>
        ...
        {/* References */}
        <section className="mb-8">
          <h2 className="text-xl font-bold mb-4">🧑‍⚖️ References</h2>
          <ul className="space-y-4">
            <li>
              ...
              <br />
              📞{" "}
              <a href="tel:+905058774583" className="hover:underline">
                +90 505 877 45 83
              </a>
            </li>
            <li>
              ...
              <br />
              📞{" "}
              <a href="tel:+905065478474" className="hover:underline">
                +90 506 547 84 74
              </a>
            </li>
            <li>
              ...
              <br />
              📞{" "}
              <a href="tel:+905448370117" className="hover:underline">
                +90 544 837 01 17
              </a>
            </li>
          </ul>
